...
echo_and_run cd "/home/brl/object_picker/src/rosdeps/panda_gazebo/panda_gazebo"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/brl/object_picker/src/rosdeps/panda_gazebo/panda_gazebo/setup.py" \
    egg_info --egg-base /home/brl/object_picker/build/rosdeps/panda_gazebo/panda_gazebo \
    build --build-base "/home/brl/object_picker/build/rosdeps/panda_gazebo/panda_gazebo" \
    install \
    --root="${DESTDIR-/}" \
