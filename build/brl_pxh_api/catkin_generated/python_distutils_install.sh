...
echo_and_run cd "/home/brl/object_picker/src/brl_pxh_api"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/brl/object_picker/src/brl_pxh_api/setup.py" \
     \
    build --build-base "/home/brl/object_picker/build/brl_pxh_api" \
    install \
    --root="${DESTDIR-/}" \
