...
"""autogenerated by genpy from brl_pxh_api/EePoseCompActionResult.msg. Do not edit."""
import codecs
import sys
...
class EePoseCompActionResult(genpy.Message):
  _md5sum = "bf337dc37a306d4afe42c82d467cab4a"
  _type = "brl_pxh_api/EePoseCompActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','brl_pxh_api/EePoseCompResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(EePoseCompActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = brl_pxh_api.msg.EePoseCompResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = brl_pxh_api.msg.EePoseCompResult()
