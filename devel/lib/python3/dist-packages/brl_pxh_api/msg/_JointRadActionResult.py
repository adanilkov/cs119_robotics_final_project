...
"""autogenerated by genpy from brl_pxh_api/JointRadActionResult.msg. Do not edit."""
import codecs
import sys
...
class JointRadActionResult(genpy.Message):
  _md5sum = "bf337dc37a306d4afe42c82d467cab4a"
  _type = "brl_pxh_api/JointRadActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','brl_pxh_api/JointRadResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(JointRadActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = brl_pxh_api.msg.JointRadResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = brl_pxh_api.msg.JointRadResult()
