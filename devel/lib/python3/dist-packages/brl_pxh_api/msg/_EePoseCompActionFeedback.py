...
"""autogenerated by genpy from brl_pxh_api/EePoseCompActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class EePoseCompActionFeedback(genpy.Message):
  _md5sum = "68e2248a6c16c0a948e35f001af0395b"
  _type = "brl_pxh_api/EePoseCompActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','brl_pxh_api/EePoseCompFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(EePoseCompActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = brl_pxh_api.msg.EePoseCompFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = brl_pxh_api.msg.EePoseCompFeedback()
