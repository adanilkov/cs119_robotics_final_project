...
"""autogenerated by genpy from brl_pxh_api/ConstPoseActionResult.msg. Do not edit."""
import codecs
import sys
...
class ConstPoseActionResult(genpy.Message):
  _md5sum = "bf337dc37a306d4afe42c82d467cab4a"
  _type = "brl_pxh_api/ConstPoseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','brl_pxh_api/ConstPoseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ConstPoseActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = brl_pxh_api.msg.ConstPoseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = brl_pxh_api.msg.ConstPoseResult()
