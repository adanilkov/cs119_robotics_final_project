...
class GripperPressureFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GripperPressureFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GripperPressureFeedback(null);
...
module.exports = GripperPressureFeedback;
