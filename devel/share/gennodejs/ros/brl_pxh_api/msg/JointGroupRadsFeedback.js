...
class JointGroupRadsFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new JointGroupRadsFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new JointGroupRadsFeedback(null);
...
module.exports = JointGroupRadsFeedback;
